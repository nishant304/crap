...
<?php echo form_open('teacher_controller/add_teacher_leave');?>
  <div class="panel panel-default del_radius">
    ...
    <div class="panel-body del_clr">
    	    <div class="col-lg-12 del_list ">
                  ...
                  <option value="sick">Other</option>
                ...
                <div class="col-lg-12 del_list">
                <label class="del_label">Child&nbsp;<span class="del_str">*</span></label> 
                <select name="child" class="form-control del_row">
                  <option value="" >Select Student</option>
                  <?php foreach ($fetch_student as $key => $value) { ?>
                    
                  
                  <option value="<?php echo $value['std_id']; ?>"><?php echo $value['std_fname']." ".$value['std_lname']; ?></option>
                  <?php } ?>
                  </select>
               </div>
    	...
    	<div class="col-lg-12">
  		<button type="submit" name="submit" class="btn btn-primary del_btnn" value="student">send</button>
  	</div>
    </div>
  </div>
  ...
  <table class="table table-hover table-responsive">
    ...
    <?php
    $i=1;
    foreach ($fetch_student_leave as $key ) {?>
