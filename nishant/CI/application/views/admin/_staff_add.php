			...
			<div class="main-page signup-page" style="margin-top: -21px;">
				...
				<div class="sign-up-row widget-shadow">
					...
					<div class="sign-u">
						...
						<input type="date" name="staff_birth_date" required style="width: 100%;">
					...
					<div class="sign-u">
						...
						<div class="sign-up2">
							<label>
								<input type="radio" name="staff_gender" value="male">
								Male
							</label>
							<label>
								<input type="radio" name="staff_gender" value="female">
								Female
							</label>
						</div>
						<div class="clearfix"> </div>
					...
					<div class="sub_home">
							...
							<input type="submit" name="staff_register" value="Submit">
