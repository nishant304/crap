		...
		<div id="page-wrapper">
			<div class="main-page login-page">
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Welcome to School Admin Panel<br> Not a Member? <a href="register">  Sign Up »</a> </h4>
					</div>
					<div class="login-body">
						<?php echo form_open('admission/admin_login_function'); ?>
							<input type="text" class="user" name="admin_email" placeholder="Enter your email" required="">
		 ...
		 <div class="footer">
       <p>&copy; 2018 School Admin Panel. All Rights Reserved | Design by <a href="http://www.tecinso.com/" target="_blank">tecinso.in</a></p>
    </div>
