  ...
  <div id="page-wrapper">
  <h2 class="exm_mrks">Exam Marks & Test Marks</h2>
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home" class="exm_agn">Exam Marks</a></li>
    <li><a data-toggle="tab" href="#menu1" class="exm_agn">Test Marks</a></li>
  </ul>
...
echo form_open('admission/marks_stored',$attribute);
...
<center><h1 class="std_log">Exam Marks</h1></center>
  <div class="col-lg-12 ">
 ...
 <div class="col-lg-2">
  ...
  <option value="<?php echo  $name3['exam_type'];   ?>"><?php echo  $name3['exam_type'];   ?></option>
     ...
     <select  name="exam_date" id="tabbb231" class="slct_main col-lg-12" onchange="examdate(this.value);">
      <option value="<?php echo  $name3['exam_date'];   ?>"><?php echo  $name3['exam_date'];   ?></option>
     </select>
     </div>
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/admission/class_record_exam_type/"+value+"/"+classs+"/"+Section+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/admission/class_record_exam_id/"+value+"/"+classs+"/"+Section+"/"+sub+"/"+xam+"/"+dat+"/",  
