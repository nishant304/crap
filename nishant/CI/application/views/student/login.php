			...
			<div class="main-page login-page ">
				...
				<div class="widget-shadow">
					...
					<div class="login-body">
						<?php echo form_open('student_controller/student_login_function'); ?>
							<input type="text" class="user" name="std_email" placeholder="Enter your email" required="">
							<input type="password" name="std_password" class="lock" placeholder="password">
