					 	...
					 	$photo1='<img src="http://localhost/CI/application/assets/images/default_image.jpg">';
						    ...
						    <!-- <tr class="active"> -->
						     ...
						     <td style="width: 146px;"><?php if($staff_image == '') { echo $photo1; } else { echo $photo; }?></td>
						      ...
						      <td><a href="<?php echo base_url(); ?>index.php/teacher_controller/student_data_update/<?php echo $staff_id; ?>">Edit</a>/<a href="<?php echo base_url(); ?>index.php/teacher_controller/staff_delete/<?php echo $staff_id; ?>">Delete</a></td>
						      </tr>
						      <?php $i++; } ?>
						    </tbody>
						</table> 
