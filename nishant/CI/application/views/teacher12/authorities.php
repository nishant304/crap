<?php
 ...
 ?>
<?php if($this->session->flashdata('stf_data') == FALSE){ echo form_open('teacher_controller/assign_authority');} else { echo form_open('teacher_controller/authority_change/'.$stf_id);} ?>
  <div class="form-group col-lg-6 col-lg-offset-5" style="margin-top: 117px;width: 325px;">
  ...
  <div class="col-lg-10 col-lg-offset-2 techr_all_authoty autho2">
   ...
   ?>
    ...
    <div class="col-lg-12">
     ...
     <div class="col-lg-12">
      ...
      <div class="col-lg-2"><label class="fa fa-check-square-o read_auth"><input class="chk_rdio" type="checkbox" value="1" name="stu_detail[]" <?php foreach ($exp['stu_detail'] as $key => $value) {
       if($value=='1'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o write_auth"><input class="chk_rdio" type="checkbox" value="2" name="stu_detail[]" <?php foreach ($exp['stu_detail'] as $key => $value) {
       if($value=='2'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o del_auth"><input class="chk_rdio" type="checkbox" value="3" name="stu_detail[]" <?php foreach ($exp['stu_detail'] as $key => $value) {
       if($value=='3'){     ?> checked <?php  }
      ...
      <div class="col-lg-2"><label class="fa fa-check-square-o read_auth"><input class="chk_rdio" type="checkbox" value="1" name="stf_detail[]" <?php foreach ($exp['stf_detail'] as $key => $value) {
       if($value=='1'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o write_auth"><input class="chk_rdio" type="checkbox" value="2" name="stf_detail[]" <?php foreach ($exp['stf_detail'] as $key => $value) {
       if($value=='2'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o del_auth"><input class="chk_rdio" type="checkbox" value="3" name="stf_detail[]" <?php foreach ($exp['stf_detail'] as $key => $value) {
       if($value=='3'){     ?> checked <?php  }

      }   ?>></label></div>
    </div> <div class="col-lg-12">
      <div class="col-lg-6"><h4>Student Admission</h4></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o read_auth"><input class="chk_rdio" type="checkbox" value="1" name="stu_admission[]" <?php foreach ($exp['stu_admission'] as $key => $value) {
       if($value=='1'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o write_auth"><input class="chk_rdio" type="checkbox" value="2" name="stu_admission[]" <?php foreach ($exp['stu_admission'] as $key => $value) {
       if($value=='2'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o del_auth"><input class="chk_rdio" type="checkbox" value="3" name="stu_admission[]" <?php foreach ($exp['stu_admission'] as $key => $value) {
       if($value=='3'){     ?> checked <?php  }
    ...
    <div class="col-lg-12">
      ...
      <div class="col-lg-2"><label class="fa fa-check-square-o read_auth"><input class="chk_rdio" type="checkbox" value="1" name="stf_reg[]" <?php foreach ($exp['stf_reg'] as $key => $value) {
       if($value=='1'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o write_auth"><input class="chk_rdio" type="checkbox" value="2" name="stf_reg[]" <?php foreach ($exp['stf_reg'] as $key => $value) {
       if($value=='2'){     ?> checked <?php  }

      }   ?>></label></div>
      <div class="col-lg-2"><label class="fa fa-check-square-o del_auth"><input class="chk_rdio" type="checkbox" value="3" name="stf_reg[]" <?php foreach ($exp['stf_reg'] as $key => $value) {
       if($value=='3'){     ?> checked <?php  }
    ...
    <div class="col-lg-12 col-lg-offset-5">
      <input type="submit" value="Assign" name="assign_role">
    </div>
  </div>
