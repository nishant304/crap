...
<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
					 	...
					 	$file = $ebook['file'];
						    ...
						    <tr class="active">
						     <th scope="row"><?php echo $i; ?></th>
						      ...
						      <td><?php echo $file; ?></td>
						      <td><a href="<?php echo base_url(); ?>index.php/teacher_controller/ebook_data_update/<?php echo $id; ?>">Edit</a>/<a href="<?php echo base_url(); ?>index.php/teacher_controller/ebook_delete/<?php echo $id; ?>">Delete</a></td> 
						      </tr>
						      <?php $i++; } ?>
						    </tbody>
						</table> 
			...
			<div class="add_file col-lg-offset-5">
				...
				<input class="btn btn-warning" type = "submit" name="submit" value = "upload" /></div>
				</div>
		</div>
					<?php echo form_close(); ?>
				</div>
