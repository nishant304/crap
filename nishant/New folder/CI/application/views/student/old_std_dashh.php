...
// print_r($std_email);
?>		
		<div id="page-wrapper" class="col-lg-10 page23">
  ...
  if($date_db1["day"] == $date_slct["day"] && $date_db1["month"] == $date_slct["month"])
  {
   ...
   $photo='<img src="http://localhost/CI/application/assets/images/happybday.ico"/>'." "."Happy B'Day"." ".$value['std_fname']." ".$value['std_lname'];?>
      <tr>
      	<center>
...
$('#holder').calendar({
  ...
  <input type="text" id="myInput" placeholder="Title..." class="inptsss_clrsss">
  <span onclick="newElement()" class="addBtn">Add</span>
</div>

<ul id="myUL">
  <li id="fab">Hit the gym</li>
  <li id="fab" class="checked">Pay bills</li>
  <li id="fab">Meet George</li>
  <li id="fab">Buy eggs</li>
  <li id="fab">Read a book</li>
  <li id="fab"> Organize office</li>
</ul>
...
function newElement() {
  ...
  if (inputValue === '') {
    ...
    document.getElementById("myUL").appendChild(li);
      li.appendChild(span);
$("myUL > li:nth-child(7) > .trigger").attr("id","fab");
  }
