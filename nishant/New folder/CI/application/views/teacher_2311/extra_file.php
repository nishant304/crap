...
<?php } ?>
 ...
 <option>Select</option>
<?php foreach($subject_name['cls_name'] as $key){   ?>
    <option value="<?php echo $key['sub_name'];   ?>"><?php echo $key['sub_name'];   ?></option>
    <?php } ?>
    </select>
   </div>
  ...
  <option>Select</option>
  <?php foreach($subject_name['exm_typ_date'] as $key){   ?>
  <option value="<?php echo $key['exam_type'];   ?>"><?php echo $key['exam_type'];   ?></option>
     ...
     <option>Select</option>
      <?php foreach($subject_name['exm_typ_date'] as $key){   ?>
      <option value="<?php echo $key['exam_date'];   ?>"><?php echo $key['exam_date'];   ?>
      <?php } ?>   
     </select>
     </div>
  ...
  <div class="col-lg-2">
     ...
     <input type="hidden" name="exam_id" value="<?Php echo $key['exam_id'];  ?>" id="exam_id_sec">
     <input type="submit" name="submit" id="submitty">
...
<!-- student mark for class incharge start -->
<!-- <script type="text/javascript">
  function student_mark_fetch(value)
  {
   
var cls1 = document.getElementById('std_classs').value;
var sec1 = document.getElementById('tabbb_section').value;
var sub1 = document.getElementById('tabbb1').value;
var xam1 = document.getElementById('tabbb23').value;
var dat1 = document.getElementById('tabbb231').value;

$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_data/"+cls1+"/"+sec1+"/"+sub1+"/"+xam1+"/"+dat1+"/",  
  data    : {'cls':cls1,'sec':sec1,'sub':sub1,'exm':xam1,'dat':dat1
  },
    success : function(data){
      alert(data);
...
<!-- student mark for class incharge end -->
