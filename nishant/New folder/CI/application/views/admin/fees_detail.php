...
<div class="form-group">
   ...
   <label class="col-lg-2 control-label">Fees type</label>
               <div class="input-group col-lg-8">
...
<div class="form-group">
   ...
   <label class="col-lg-2 control-label">Fees Category</label>
               <div class="input-group col-lg-8">
...
<div class="form-group">
   ...
   <label class="col-lg-2 control-label">Ammount</label>
               <div class="input-group col-lg-8">
...
<div class="form-group">
   ...
   <label class="col-lg-2 control-label">late Payment</label>
               <div class="input-group col-lg-8">
                  <span class="input-group-addon std_fnt" ><i class="fa fa-calendar" aria-hidden="true"></i></span> 
