...
<!-- student birthday start -->
<div class="panel panel-default sch_frm">
    <div class="panel-heading sch_frmmss"><h2>Birthday</h2></div>
    <div class="panel-body">
      <div class="col-lg-12">
        <table class="table table-responsive table-bordered table-hover">
          ...
          <tbody>
    <?php
      foreach ($incharge_data['incharge'] as $key => $inch)
       {
      $class_1 = $inch['class_name'];
      $section_1 = $inch['class_section'];
      }
  ...
  if($date_db1["day"] == $date_slct["day"] && $date_db1["month"] == $date_slct["month"] && $value['std_class'] == $class_1 && $value['std_section'] == $section_1 )
  {
...
<!-- student birthday end -->


   <!-- authority Start of Teacher -->
  <div class="col-lg-12 techr_all_authoty autho2 tch_auth">
