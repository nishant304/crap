<?php 
$user_listedd=explode(',',$role_autho[0]['test_marks']);
...
<?php echo form_open('teacher_controller/test_marks_stored'); ?>
<?php }  ?>
<?php 
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_marks_test_insert/"+value+"/"+sstd_id+"/"+std_classs+"/"+tabbb_section+"/"+std_sub+"/"+xam_typ+"/"+xam_date+"/"+exam_id_sec+"/"+max_mark+"/"+description+"/"+month+"/"+year+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_test/"+value+"/"+classs+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_sub/"+value+"/"+classs+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_test_type/"+value+"/"+classs+"/"+Section+"/",  
...
$.ajax({  
       type    : "POST",
       url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_test_date/"+value+"/"+classs+"/"+Section+"/"+sub+"/"+xam+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_test_id/"+value+"/"+classs+"/"+Section+"/"+sub+"/"+xam+"/"+dat+"/",  
...
$.ajax({  
    type    : "POST",
    url     : "<?php echo base_url();?>index.php/teacher_controller/class_record_test/"+value+"/"+classs+"/"+Section+"/"+sub+"/"+xam+"/"+dat+"/",  
