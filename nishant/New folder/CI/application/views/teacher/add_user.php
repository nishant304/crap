<?php 
$add_userr=explode(',',$role_autho[0]['add_user']);
$this->session->set_userdata('add_userrr',$add_userr);
echo $ad_user1=$add_userr[0];
echo $ad_user2=$add_userr[1];
echo $ad_user3=$add_userr[2];
   ?>
 ...
 <h2 class="cmbi_frms">Add Users</h2>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade">
     <?php if($ad_user1!=1 ||$ad_user1==1 && $ad_user2==2){     ?>
